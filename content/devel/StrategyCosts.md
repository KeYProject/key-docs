---
title: "Strategy Costs and the Cost-Band Ladder"
weight: 100
---
...
{{% alert title="Status: open pull request" type="warning" %}}
...
The [cost tables appendix](StrategyCostTables.md) repeats this table and lists
every combination and theory-local cost constant for reference.
...
{{% alert title="Verifying a cost change" type="warning" %}}
