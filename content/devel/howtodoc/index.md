...
``` markdown
{{% alert title="Phasellus posuere in sem ut cursus" type="info" %}}
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla et euismod
nulla. Curabitur feugiat, tortor non consequat finibus, justo purus auctor
massa, nec semper lorem quam in massa.
{{% /alert %}}
...
{{% tabpane %}}
{{% tab header=":octicons-arrow-right-16: inline end" %}}
...
{{% /tab %}}
{{% tab header=":octicons-arrow-left-16: inline" %}}
...
{{% tabpane %}}
{{% tab header=":octicons-file-code-16: docs/example.md" %}}
...
{{% /tab %}}
{{% tab header=":octicons-file-code-16: docs/stylesheets/extra.css" %}}
...
{{% /tab %}}
{{% tab header=":octicons-file-code-16: mkdocs.yml" %}}
