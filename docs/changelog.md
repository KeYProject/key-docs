...
* [Removal of Triple, and Quadruple](https://github.com/KeYProject/key/pull/3529)
* [Use KeYParser.g4 for parsing proof scripts](https://github.com/KeYProject/key/pull/3021)
* [Migration to java.nio.Path](https://github.com/KeYProject/key/pull/3618)
* [Refactoring context menus of sequent views](https://github.com/KeYProject/key/pull/3641)
* [AST for KeY Scripts](https://github.com/KeYProject/key/pull/3587)
* [Higher Order Proof Scripts](https://github.com/KeYProject/key/pull/3654)
* [Modularization: InfFlow and WD as separate modules](https://github.com/KeYProject/key/pull/3640)
* [Make the context menu more flexibel and type safe.](https://github.com/KeYProject/key/pull/3785)
* [Purge sort depending functions in favor of parametric functions](https://github.com/KeYProject/key/pull/3773)
* [Make \sameUpdateLevel the default](https://github.com/KeYProject/key/pull/3899)

### Exciting New Features 🎉
* [Extract Taclets and Prover Main Loop to ncore](https://github.com/KeYProject/key/pull/3578)
...
* [The Removal of Recoder](https://github.com/KeYProject/key/pull/3120)
* [Proof Scripts in JML](https://github.com/KeYProject/key/pull/3657)
### Features
* [Proposing a more flexible lexing framework](https://github.com/KeYProject/key/pull/3537)
* [highlight current line in issue editor pane](https://github.com/KeYProject/key/pull/3573)
* [Improved treatment of final fields](https://github.com/KeYProject/key/pull/3495)
* [Enable SMT focus goals (unsat cores) for CVC5](https://github.com/KeYProject/key/pull/3594)
* [SMT test cases rework](https://github.com/KeYProject/key/pull/3592)
* [Isabelle Translation](https://github.com/KeYProject/key/pull/3514)
* [Introducing some structure for model method bodies](https://github.com/KeYProject/key/pull/3571)
* [Linearized symbolic execution in proof tree](https://github.com/KeYProject/key/pull/3237)
* [KeY/JSON config for SMT solvers](https://github.com/KeYProject/key/pull/3597)
* [Save proof independent settings, that are not used by the configuration](https://github.com/KeYProject/key/pull/3700)
* [Send Feedback using Github issues](https://github.com/KeYProject/key/pull/3736)
* [Pfeifer/proof mgmt includes fix](https://github.com/KeYProject/key/pull/3757)
* [Add sort aliases](https://github.com/KeYProject/key/pull/3778)
* [Give similar taclet names if taclet not found during proof loading](https://github.com/KeYProject/key/pull/3784)
* [Add support for Annotation Processors in the Javac Extension](https://github.com/KeYProject/key/pull/3686)
* [Options Panel in Load Dialog. Options in Recent Files](https://github.com/KeYProject/key/pull/3788)
* [Add support for `var` variable declarations](https://github.com/KeYProject/key/pull/3821)
* [Basic Theory of Sets](https://github.com/KeYProject/key/pull/3777)
* [Collapsing proof search](https://github.com/KeYProject/key/pull/3825)
* [Improvements for the Taclet Match Dialog](https://github.com/KeYProject/key/pull/3830)
* [Allow realizing multiple cached branches at once](https://github.com/KeYProject/key/pull/3440)
* [automode to choose from a dropdown list](https://github.com/KeYProject/key/pull/3857)
* [Feature: Version-based Configuration Paths](https://github.com/KeYProject/key/pull/3888)
* [Fix compact constructor in Records](https://github.com/KeYProject/key/pull/3905)
* [Soundiness dialog for making assumptions explicit](https://github.com/KeYProject/key/pull/3887)
### Bug Fixes
* [Add conversion rules for Float/Double negation](https://github.com/KeYProject/key/pull/3520)
* [Fix #3524](https://github.com/KeYProject/key/pull/3525)
* [Fixing the broken automode](https://github.com/KeYProject/key/pull/3533)
* [Fix #3452](https://github.com/KeYProject/key/pull/3540)
* [fix #3553](https://github.com/KeYProject/key/pull/3560)
* [Fix #3563](https://github.com/KeYProject/key/pull/3566)
* [Fix line number alignment in SMT interface](https://github.com/KeYProject/key/pull/3559)
* [Adding a rule for exactInstance of final types. (fixes #3389)](https://github.com/KeYProject/key/pull/3543)
* [fixing lexing to support static invariants](https://github.com/KeYProject/key/pull/3583)
* [Fixed obtaining results from CVC4 and cvc5](https://github.com/KeYProject/key/pull/3593)
* [Fix Java version in nightlydeploy.yml](https://github.com/KeYProject/key/pull/3598)
* [Fix exception in javac extension](https://github.com/KeYProject/key/pull/3609)
* [fix testMakeFilenameRelativeWindows](https://github.com/KeYProject/key/pull/3619)
* [Disable relative path test on Windows](https://github.com/KeYProject/key/pull/3629)
* [Fix SMT ApplyAction not pruning when undoing](https://github.com/KeYProject/key/pull/3606)
* [Fix NPE using KeY command line interface caused by Java NIO](https://github.com/KeYProject/key/pull/3643)
* [FIX: URGENT: Changes in Gradle 9 results into non-execution of custom test tasks.](https://github.com/KeYProject/key/pull/3653)
* [fix css for sequentview syntaxhighlightning](https://github.com/KeYProject/key/pull/3645)
* [Allow `true` in more JML expressions](https://github.com/KeYProject/key/pull/3664)
* [Fix NPE in dependency contract feature (caused by pulled out expression)](https://github.com/KeYProject/key/pull/3675)
* [Fix Information Flow Proof Loading for KeY Jar File](https://github.com/KeYProject/key/pull/3678)
* [Enable assertion for :key.ui:run](https://github.com/KeYProject/key/pull/3682)
* [Fix proof task tree forced white background.](https://github.com/KeYProject/key/pull/3663)
* [Fix deadlock when showing JML warnings dialog](https://github.com/KeYProject/key/pull/3692)
* [Check for applicability of Antec-/SuccTaclets in Proof Replay](https://github.com/KeYProject/key/pull/3702)
* [Return to Metal as default Look and Feel](https://github.com/KeYProject/key/pull/3658)
* [fix #3721, getParent().toUri() requires absolute paths](https://github.com/KeYProject/key/pull/3722)
* [Fix unbalanced block exception when pretty printing heap terms](https://github.com/KeYProject/key/pull/3726)
* [Add reachable Java state properties to invariant for modified local variables (fixes #3728)](https://github.com/KeYProject/key/pull/3747)
* [Fix for #3738: Fix SMT type axiomatisation for interfaces](https://github.com/KeYProject/key/pull/3749)
* [Anonymize ghost variables in loop](https://github.com/KeYProject/key/pull/3729)
* [Proof Management: Ignore internal contracts when calculating dependency state (fixes #3745)](https://github.com/KeYProject/key/pull/3748)
* [Fix for #3683: Hiding package prefixes in sequent view](https://github.com/KeYProject/key/pull/3684)
* [Taclet definition added to problemHeader](https://github.com/KeYProject/key/pull/3733)
* [put CachingExtension into the correct service file.](https://github.com/KeYProject/key/pull/3782)
* [move Taclet options of WD from key.core to key.core.wd](https://github.com/KeYProject/key/pull/3783)
* [Allow KeY to start even in case of unreadable recent files](https://github.com/KeYProject/key/pull/3790)
* [ProofManagement extension: Iterative NodeIntermediateWalker to avoid stack overflows](https://github.com/KeYProject/key/pull/3793)
* [Dependency Contract: Ignore all term labels when searching for base term](https://github.com/KeYProject/key/pull/3776)
* [Alternative for #3393: Fix slicing bug related to Evaluate Query](https://github.com/KeYProject/key/pull/3794)
* [Fix field names in Isabelle translation](https://github.com/KeYProject/key/pull/3795)
* [Enable KeY to distinguish between classes of same name in different packages](https://github.com/KeYProject/key/pull/3805)
* [Improve behavior in case of not found methods](https://github.com/KeYProject/key/pull/3806)
* [Fix naming and renaming issues](https://github.com/KeYProject/key/pull/3804)
* [Fix Path bug](https://github.com/KeYProject/key/pull/3810)
* [Fix bug in ProofManagementDialog](https://github.com/KeYProject/key/pull/3812)
* [Fix 'choose contract' in parser](https://github.com/KeYProject/key/pull/3840)
* [Fixes for minor regressions on main](https://github.com/KeYProject/key/pull/3844)
* [Make new name creation only dependent on goal namespaces not on global counter](https://github.com/KeYProject/key/pull/3848)
* [Fix per-proof memory leak: clear JavaParserFacade cache on dispose](https://github.com/KeYProject/key/pull/3854)
* [Make cross-platform path/URI/charset handling in load/save more robust](https://github.com/KeYProject/key/pull/3860)
* [Fix "Rule of same name exists already" error after pruning (rare but occuring cases after mass pruning with try-closeable-goals)](https://github.com/KeYProject/key/pull/3850)
* [Fix most-recent file not set after loading recent-files list (#3711)](https://github.com/KeYProject/key/pull/3866)
* [Reject generic sorts at user-input boundaries: \problem, JML, taclet instantiation (#3409)](https://github.com/KeYProject/key/pull/3869)
* [Fix fast-click auto-mode crash: overlapping runs + proof breaking proof listeners](https://github.com/KeYProject/key/pull/3880)
* [Fix NPE when copying a namespace set with a root sub-namespace](https://github.com/KeYProject/key/pull/3881)
* [Follow-up fixes for cost-reuse: remove unsound static caches](https://github.com/KeYProject/key/pull/3873)
* [Implement \real literals (#3570); fix LogicPrinter.quickPrintSemisequent (#243)](https://github.com/KeYProject/key/pull/3865)
* [Fix changing Taclet Options via the GUI (and more) + TimSort source files added as examples](https://github.com/KeYProject/key/pull/3889)
* [Fix two soundness gaps in select/permission taclets](https://github.com/KeYProject/key/pull/3891)
* [Cost-Reuse: Fix latent classification bugs and code cleanup](https://github.com/KeYProject/key/pull/3890)
* [Fix GUI crashes when no proof is loaded, and remove dead MainWindowTabbedPane](https://github.com/KeYProject/key/pull/3892)
* [Fix for DepthFirstGoalChooser: Keep enabled sibling goals on a split](https://github.com/KeYProject/key/pull/3886)
* [Fix finalFields default in FinalHeapResolution.isFinalEnabled](https://github.com/KeYProject/key/pull/3895)
* [Fixes "No Proof" in status line when a proof was closed.](https://github.com/KeYProject/key/pull/3900)
* [Ensure default option for pruning/disposing of cache sources is set properly](https://github.com/KeYProject/key/pull/3901)
* [Microfix: Missing ',' in CLUTTER_RULES prevented rules to be lower prioritized (as their two name were joined together)](https://github.com/KeYProject/key/pull/3906)
* [Fix pruning of cached branches](https://github.com/KeYProject/key/pull/3858)
* [Fix broken proof tree after information flow auto pilot](https://github.com/KeYProject/key/pull/3911)
* [Respect the \profile declaration of loaded files again](https://github.com/KeYProject/key/pull/3912)
* [Use default key stroke settings when no settings file exists](https://github.com/KeYProject/key/pull/3913)
* [Fix: Automode button in Strategy Pane could not be used to stop automode](https://github.com/KeYProject/key/pull/3896)
* [Fix file dependency for runAntlr4KeY](https://github.com/KeYProject/key/pull/3920)
* [Enforce profile when selected via file chooser](https://github.com/KeYProject/key/pull/3921)
### Dependencies
* [Migrate to Gradle Version Catalog](https://github.com/KeYProject/key/pull/3894)
...
* [fixes Location#compareTo(Location)](https://github.com/KeYProject/key/pull/3519)
* [RuleApp interface for all external solvers (prep for #3514)](https://github.com/KeYProject/key/pull/3521)
* [Missing project description for two sub-modules](https://github.com/KeYProject/key/pull/3528)
* [Re-enable sonarqube for quality assessment](https://github.com/KeYProject/key/pull/3488)
* [Also depend on `checker-qual` artifact](https://github.com/KeYProject/key/pull/3535)
* [Added BoyerMoore.key](https://github.com/KeYProject/key/pull/3558)
* [repair the axiom generation for adts defined in JavaDL](https://github.com/KeYProject/key/pull/3556)
* [Fix/Improve KeY example application](https://github.com/KeYProject/key/pull/3562)
* [Cleanup: Removal of key.api package](https://github.com/KeYProject/key/pull/3550)
* [Add documentation for soundDefaultContracts feature](https://github.com/KeYProject/key/pull/3574)
* [Use a custom Github action for setting up the SMT solvers](https://github.com/KeYProject/key/pull/3569)
* [Improve JavaDocs for Qualifier, SyntaxElement](https://github.com/KeYProject/key/pull/3579)
* [Warn on missing SMT solvers if flag is set](https://github.com/KeYProject/key/pull/3600)
* [Fix for a performance regression](https://github.com/KeYProject/key/pull/3607)
* [Fix Checker Framework Errors](https://github.com/KeYProject/key/pull/3610)
* [Fix deprecated Gradle build syntax, update `shadow` dependency](https://github.com/KeYProject/key/pull/3612)
* [Fix graphviz configuration of slicing extension](https://github.com/KeYProject/key/pull/3613)
* [Remove duplicate NewDependingOn class](https://github.com/KeYProject/key/pull/3615)
* [Generalize Taclet Implementation](https://github.com/KeYProject/key/pull/3605)
* [Rename core Term/Operator/...  to  JTerm/JOperator... to avoid name clashes with ncore Term/Operator/...](https://github.com/KeYProject/key/pull/3616)
* [Move Taclet matching infrastructure to ncore](https://github.com/KeYProject/key/pull/3608)
* [Using FlatLAF for a modern look and feel](https://github.com/KeYProject/key/pull/3599)
* [Cleanup: Remove antlr3 + antlr2 from the classpath](https://github.com/KeYProject/key/pull/3624)
* [Fix some indirect dependencies by updating used plugins that introduce them](https://github.com/KeYProject/key/pull/3626)
* [Test if matrix over modules are a good thing](https://github.com/KeYProject/key/pull/3622)
* [Cleanup: Use Standard Tech for Test Fixtures](https://github.com/KeYProject/key/pull/3551)
* [Remove unnecessary (and harmful) license plugin](https://github.com/KeYProject/key/pull/3628)
* [Reduce raw usage of classes](https://github.com/KeYProject/key/pull/3634)
* [Fix multiple SLF4J providers](https://github.com/KeYProject/key/pull/3639)
* [Indent switch expressions](https://github.com/KeYProject/key/pull/3636)
* [Translation of bitwise operators](https://github.com/KeYProject/key/pull/3172)
* [Throw an error when encountering an undefined rule set](https://github.com/KeYProject/key/pull/3644)
* [Preparation for generalizing rule indexing](https://github.com/KeYProject/key/pull/3620)
* [Improvements for AbbrevMap](https://github.com/KeYProject/key/pull/3647)
* [small fixes to datatype handling](https://github.com/KeYProject/key/pull/3661)
* [Improve error message in headless mode](https://github.com/KeYProject/key/pull/3685)
* [Set version to 2.13.0-dev](https://github.com/KeYProject/key/pull/3689)
* [Generate easier POs for non-trivial diverges clauses](https://github.com/KeYProject/key/pull/3430)
* [(Re-)activating an ancient rule for the treatment of exactInstance of null](https://github.com/KeYProject/key/pull/3706)
* [Migrating to central portal from OSSRH, due to OSSRH shutdown in summer'25](https://github.com/KeYProject/key/pull/3604)
* [Fix nullchecker](https://github.com/KeYProject/key/pull/3732)
* [Fix NPE in proof tree when using global filters](https://github.com/KeYProject/key/pull/3755)
* [Refixing #3721: Starting KeY UI with local files](https://github.com/KeYProject/key/pull/3754)
* [Modularity for Proof Strategies](https://github.com/KeYProject/key/pull/3650)
* [Update and fix Broad Release Tests](https://github.com/KeYProject/key/pull/3703)
* [Support for TextBlockLiterals](https://github.com/KeYProject/key/pull/3796)
* [Record support by transformation](https://github.com/KeYProject/key/pull/3758)
* [Suppression of log for non-failing test classes](https://github.com/KeYProject/key/pull/3746)
* [Update function explanations to new syntax](https://github.com/KeYProject/key/pull/3811)
* [Update Gradle version to 9.5 and deprecated method replacements](https://github.com/KeYProject/key/pull/3813)
* [Remove codecov from CI](https://github.com/KeYProject/key/pull/3802)
* [Artifacts are now on mvn central](https://github.com/KeYProject/key/pull/3820)
* [Local performance improvements](https://github.com/KeYProject/key/pull/3824)
* [Improvements of Error Messages and Accurracy of Error Position Reporting](https://github.com/KeYProject/key/pull/3826)
* [Improve Update Simplification for Long Programs](https://github.com/KeYProject/key/pull/3828)
* [Deployment to Maven Central SNAPSHOT](https://github.com/KeYProject/key/pull/3819)
...
* [Taclet match dialog: collapse big matched terms; add an editor for SV fields](https://github.com/KeYProject/key/pull/3855)
* [Fix newline escape for Windows](https://github.com/KeYProject/key/pull/3856)
* [Further improvements on error message reporting](https://github.com/KeYProject/key/pull/3859)
* [Performance (5/5): operator-indexed parking of assumes-incomplete rule-app bases](https://github.com/KeYProject/key/pull/3838)
* [Performance (3/5): skip the checkPrefix prefix-walk when no transformer is present](https://github.com/KeYProject/key/pull/3836)
* [Performance (2/5): cut proof-search allocations + release the parser DFA cache](https://github.com/KeYProject/key/pull/3835)
* [Performance (1/5): Matching can now partially evaluate taclets](https://github.com/KeYProject/key/pull/3831)
* [Performance (4/5): reuse rule-app cost across re-expansion (+ age as a cost term)](https://github.com/KeYProject/key/pull/3837)
* [LogicPrinter: reduce per-subterm overhead and harden against unbalanced blocks](https://github.com/KeYProject/key/pull/3861)
* [Make proof-tree painting cheap on large proofs](https://github.com/KeYProject/key/pull/3863)
* [Fix intermittent key.core.testgen failures from SMT symbol-map race](https://github.com/KeYProject/key/pull/3862)
* [Regression tests for resolved parser/JML issues (#1119, #1536); pin #329](https://github.com/KeYProject/key/pull/3868)
* [MetaSpace for documentation and origin](https://github.com/KeYProject/key/pull/3787)
* [Update the InfoTree component](https://github.com/KeYProject/key/pull/3786)
* [Report missing \endmodality at the modality opening; move source-location classes to ncore (#3867)](https://github.com/KeYProject/key/pull/3870)
* [Better ImmutableList](https://github.com/KeYProject/key/pull/3816)
* [Taclet match dialog: readable \assumes candidates and smarter window placement](https://github.com/KeYProject/key/pull/3882)
* [Performance Series 2 (1/5): Faster cost computation by skipping an unnecessary proof-history walk](https://github.com/KeYProject/key/pull/3874)
* [Performance Series 2 (2/5): Faster term equality modulo renaming via a hash pre-filter](https://github.com/KeYProject/key/pull/3875)
* [Performance Series 2 (3/5): Incremental taclet re-indexing for a single added taclet](https://github.com/KeYProject/key/pull/3876)
* [Performance Series 2 (5/5): Faster quantifier-instantiation heuristic, plus code cleanup](https://github.com/KeYProject/key/pull/3878)
* [Performance Series 2 (4/5): Lower memory for the per-goal rule-application queue](https://github.com/KeYProject/key/pull/3877)
* [Removal of proof_references and symbolic_execution modules](https://github.com/KeYProject/key/pull/3910)
* [Fix recent file menu; fix #3898](https://github.com/KeYProject/key/pull/3909)
* [Add test for Java parsing coverage](https://github.com/KeYProject/key/pull/3916)
* [Support for multi-catch-clauses in try-statements](https://github.com/KeYProject/key/pull/3919)
* [Support for try-with-resources by reduction](https://github.com/KeYProject/key/pull/3918)


## [2.14.0](https://github.com/KeYProject/key/releases/tag/KEY-2.12.3) (2025-07-XX)
